...
public class TagSuivisFragment extends Fragment implements AbsListView.OnScrollListener{
    ...
    void getMoreInfos(){
        ...
        posts = diasporaBean.getMoreTagSuivis(timestampOlder, timestampNewest);
        bindMoreDatas();
        LOG.d(TAG_METHOD+ "Sortie");
    }
    @UiThread
